...
!function t(e, n, r) {
    ...
    12: [function (t, e, n) {
        ...
        var o = t("../../lib/helper"), i = t("../../lib/dom"), l = t("../instances"), s = t("../update-geometry"),
            a = t("../update-scroll");
        e.exports = function (t) {
            var e = l.get(t);
            r(t, e)
    ...
    16: [function (t, e, n) {
        ...
        function r(t, e, n, r) {
            ...
            function h(t) {
                if (!Y && w && p(t)) {
                    var e = d(t), n = {pageX: e.pageX, pageY: e.pageY}, r = n.pageX - v.pageX, o = n.pageY - v.pageY;
                    a(r, o), v = n;
    ...
    18: [function (t, e, n) {
        ...
        var s = t("../lib/class"), a = t("../lib/dom"), c = t("./default-setting"), u = t("../lib/event-manager"),
            d = t("../lib/guid"), p = t("../lib/helper"), f = {};
        n.add = function (t) {
            var e = d();
    ...
    20: [function (t, e, n) {
        ...
        var r, o, i = t("./instances"), l = document.createEvent("Event"), s = document.createEvent("Event"),
            ...
            h = document.createEvent("Event"), b = document.createEvent("Event");
